...
export const localUrls = {
  AUTH_URL: 'http://192.168.158.52:3000/users/login',
  REGISTER_URL: 'http://192.168.158.52:3000/users/register',
  LOGOUT_URL: 'http://192.168.158.52:3000/users/logout',
  ADD_WORD_USER: 'http://192.168.158.52:3000/users/addWordToKnown',
  UPDATE_LANG: 'http://192.168.158.52:3000/users/updateLang',
  GET_CATEGORIES: 'http://192.168.158.52:3000/category/categories',
  GET_BY_ID: 'http://192.168.158.52:3000/category',
  GET_WORDS_BY_CATEGORY_ID: 'http://192.168.158.52:3000/category/getWords/',
  ADD_AWARD: 'http://192.168.158.52:3000/users/addAwardToUser',
  GET_USER_DECK: 'http://192.168.158.52:3000/users/getUserAwardDeck',
  GET_QUIZ_BY_ID: 'http://192.168.158.52:3000/quiz/',
  GET_QUIZ_BY_DIffICULTY: 'http://192.168.158.52:3000/quiz/difficulty/',
  ADD_COMPLETED_QUIZ: 'http://192.168.158.52:3000/quizResult/create',
  RESET_PROCESS: 'http://192.168.158.52:3000/users/resetProcess',
  CREATE_REQUEST: 'http://192.168.158.52:3000/requests/create',
  INCREMENT_EXP: 'http://192.168.158.52:3000/users/incrementExp',
  GET_USER_STAT: 'http://192.168.158.52:3000/users/getUserStat',
  GET_USER_AWARDS: 'http://192.168.158.52:3000/users/getUserAward',
};
